    ...
    <div className="w-screen h-screen flex">
      <aside className="w-2/10 bg-white-100 p-4">
        ...
        <button
          ...
          className="w-full py-2 semi-rounded"
        ...
        {!filename ? (
          <nav style={{ color: "grey" }}>
            <ul>
              <li className="flex items-center mb-4">
                <span className="mr-2">            
                  <svg style={{ float: "left" }} xmlns="http://www.w3.org/2000/svg" color="gray" width="1em" height="1em" viewBox="0 0 24 24">
              ...
              <li className="flex items-center mb-4">
                <span className="mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2" />
                  </svg>
                </span>
                <span>Summary</span>
              </li>
          ...
          <nav>
            <ul>
              ...
              <li className="flex items-center mb-4">
                <span className="mr-2">📄</span>
                <input type='button' onClick={() => setResume(true)} value="Summary" />
              </li>
              <li className="flex items-center mb-4">
                <span className="mr-2">✏️</span>
                <input type='button' onClick={() => setExercises(true)} value="Exercises" />
              </li>
              <li className="flex items-center mb-4">
                <span className="mr-2">📝</span>
                <input type='button' onClick={() => setExam(true)} value="Tests" />
              </li>
            </ul>
          </nav>
        )}
        ...
        <main className="flex-1 p-4 bg-gray-100">
          {!filename ? (
            <div style={{ textAlign: "center", marginTop: "25%" }}>
              ...
              <button onClick={handleOpenModal} style={{ backgroundColor: '#047857', color: "white" }} className="py-2 text-600 semi-rounded">
                New document
              </button>
            </div>
          ) : (
